...
**Data Controller**
Axel Grefslie
Email: axel.grefslie@icloud.com

If you have any questions about this policy or want to exercise your data protection rights, contact us at the email above.
...
- **Account information**: email address, username, display name, and password (stored hashed by our authentication provider).
- **Profile information**: sex, bodyweight, height, and date of birth (optional, used to compute your rank and tier).
...
## 2. Why we use your data (legal bases under GDPR)

| Purpose | Legal basis |
| --- | --- |
| Creating and operating your account | Performance of a contract (Art. 6(1)(b) GDPR) |
...
We share limited data with the following processors and partners, each of whom is bound by appropriate data protection agreements:

- **Supabase, Inc.** — hosts our database, file storage, and authentication systems. Data centers in the United States and the European Union. <https://supabase.com/privacy>
- **Google Ireland Limited / Google LLC (Google AdMob)** — serves advertisements inside the app and processes advertising identifiers for ad measurement and personalization. <https://policies.google.com/privacy>
- **Apple Inc.** — distributes the app and processes App Store interactions (purchases, ratings, reviews). <https://www.apple.com/legal/privacy/>
- **Google LLC (Google Play)** — distributes the Android version of the app. <https://policies.google.com/privacy>
- **Expo Inc.** — provides our build and over-the-air update infrastructure. <https://expo.dev/privacy>

We do not sell your personal data. We do not share your data with advertisers beyond what is required for them to display ads through Google AdMob.

### 3.1 International transfers
Some of our processors are located outside the European Economic Area (EEA), primarily in the United States. Where this is the case, we rely on Standard Contractual Clauses approved by the European Commission and supplementary safeguards to ensure your data receives an adequate level of protection.
...
- **Erasure** — request deletion of your data ("right to be forgotten"). You can delete your account directly from the Profile screen in the app.
...
- Encryption in transit (TLS) for all network requests.
- Encryption at rest for stored files and database backups.
- Hashed passwords (we never store passwords in plain text).
- Row-level security policies in our database to prevent unauthorized access.
- Regular security reviews and dependency updates.

No system is perfectly secure. If you discover a vulnerability, please report it to axel.grefslie@icloud.com.
...
We display advertisements through Google AdMob to support free access to the app. When you first launch the app in the EEA, the UK, or Switzerland, you will see a consent message asking whether you allow personalized advertising. You can change your choice at any time in your device's privacy settings, or by reaching out to us.

On iOS 14.5 and later, we additionally request App Tracking Transparency permission. If you decline, you will only see non-personalized ads.

---

## 10. Changes to this policy

We may update this policy from time to time. When we make material changes we will notify you through the app or by email. The "Last updated" date at the top of this page indicates when the policy was most recently revised.
...
**Email**: axel.grefslie@icloud.com
**Postal address**: Konghellegata 10 0570 Oslo, Norway
