...
If you have questions, complaints, or want to report content or a user, contact us at the email above.
...
- You must provide accurate information at sign-up and keep your credentials secure.
- One person, one account. Impersonating another person, brand, or organisation is not allowed.
...
- **Hate, harassment, and bullying** — targeted abuse, slurs, doxxing, or content promoting hatred against any group.
- **Dangerous behaviour** — self-harm, reckless or unsafe acts, or content that promotes them.
- **Spam and scams** — repetitive promotional content, fraud, phishing.
- **Impersonation** — pretending to be another person, brand, or stealing another lifter's footage.
- **Illegal content** — anything that violates the law where you live or where we operate.

We act on reports of objectionable content **within 24 hours**. Content found to be in violation will be removed, and the responsible account may be suspended or terminated without notice.

### Automatic content removal

Content that receives **three or more independent reports** is automatically hidden from feeds, leaderboards, and detail pages pending human review. If the review confirms the violation, the content is permanently removed. If the report turns out to be a false flag, the content is restored.

False or malicious reports may themselves result in account action.
...
- **Report a lift** from the overflow menu (•••) on any lift detail page, picking one of the reasons above and optionally adding details.
- **Block another user** from their profile screen. Blocked users no longer see your content and you no longer see theirs. Existing friend requests are dropped.
- **Email us directly** at axel.grefslie@icloud.com to escalate or report anything the in-app flows do not cover. We aim to reply within 24 hours.

---

## 6. Suspension and termination

We may suspend or terminate accounts that violate these Terms, abuse the service, harass other users, or otherwise put the community at risk. You can delete your account at any time from the Profile screen; account deletion removes your profile, lifts, and personal data per the Privacy Policy.
